<!-- Modal -->
<div class="modal animated zoomIn" id="editModal{{$modelo->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-inspinia text-primary" id="exampleModalLabel">Actualizar Modelo</h5>
                       ...
                       <div class="row">
                        <div class="col-lg-12 form-group">
                          <div>
                              ...
                              <input type="text" value="{{$modelo->nombre}}"
