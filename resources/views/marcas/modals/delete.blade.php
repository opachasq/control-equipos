<!-- Modal -->
<div class="modal fade text-center" id="deleteModal{{$marca->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
                  ...
                  @method('DELETE')
                    ...
                    <div class="modal-body">
                        ...
                        <br><br>
                          ...
                          <button type="submit" href="{{route('marcas.destroy', $marca->id)}}" class="btn btn-primary">
                              ¡Si, elimínelo!
