<!-- Modal -->
<div class="modal fade text-center" id="deleteModal{{$equipo->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
                  ...
                  @method('DELETE')
                    ...
                    <div class="modal-body">
                        ...
                        <br><br>
                          ...
                          <button type="submit" href="{{route('equipos.destroy', $equipo->id)}}" class="btn btn-primary">
                              ¡Si, elimínelo!
